	...
	var ImageZoom = function () {
	  ...
	  _createClass(ImageZoom, [{
	    ...
	    value: function init(selector) {
	      ...
	      this._manager = new _hammerjs2.default.Manager(this.$image[0]);
	    ...
	    value: function _registerGestures() {
	      ...
	      var pan = new _hammerjs2.default.Pan({ direction: _hammerjs2.default.DIRECTION_ALL, threshold: 0 });
	    ...
	    value: function _registerEvents() {
	      ...
	      this._manager.on('doubleTap', function (e) {
	        var _e$center = e.center;
	        var x = _e$center.x;
	        var y = _e$center.y;
	
	        _this.scale = _this.scale > 1 ? 1 : 3;
	        _this.$image.css('transition', 'transform 0.5s');
	        _this._transform(x, y, _this.scale);
	      });
	
	      this._manager.on('pinch', function (e) {
	        _this.$image.css('transition', 'none');
	        var _e$center2 = e.center;
	        var x = _e$center2.x;
	        var y = _e$center2.y;
	
	        _this._transform(x, y, e.scale);
	      });
	      ...
	      this._manager.on('pan', function (e) {
	        ...
	        _this.currentDeltaX = _this.deltaX + e.deltaX;
	        _this.currentDeltaY = _this.deltaY + e.deltaY;
	
	        _this.$image.css({
	          'transition': 'none',
	          'transform': 'translate3d(' + _this.currentDeltaX + 'px, ' + _this.currentDeltaY + 'px, 0px) scale(' + _this.scale + ')'
	        });
	      });
